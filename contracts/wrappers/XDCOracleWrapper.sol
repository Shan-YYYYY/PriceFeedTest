...
import "../interfaces/IXDCOracle.sol";
import "../interfaces/IOracleWrapper.sol";

contract XDCOracleWrapper is IOracleWrapper, ReentrancyGuard {
    ...
    function fetchPrice(address /*_token*/) public {
    ...
    function _getOracleResponse() private view returns (OracleResponse memory response) {
        try IXDCOracle(oracle).getPrice() returns (uint256 price) {
